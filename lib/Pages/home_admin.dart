...
import 'package:integrador/Pages/ScannerQr.dart';
          ...
          child: Center(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  // Mostrar la imagen QR.png encima del texto
                  Image.asset(
                    'assets/images/QR.png', // Ruta de la imagen QR
                  ...
                  _buildListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                GuestListView()), // Aquí se navega correctamente
                      );
                    },
                  ),
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                              content: Text('${guests[index]} ha entrado')),
                        );
                      },
                    ),
                    IconButton(
